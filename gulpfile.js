...
gulp.task('vulcanize', function() {
  return gulp.src('dist/assets/elements.html')
    .pipe(vulcanize())
    .pipe(crisper())
...
gulp.task('move-webcomponentsjs', function () {
  return gulp.src(['dist/assets/bower_components/webcomponentsjs/webcomponents-lite.min.js']).pipe(gulp.dest('dist/files'));
});

gulp.task('move-font-awesome', function () {
  return gulp.src(['dist/assets/bower_components/font-awesome/css/font-awesome.min.css', 'dist/assets/bower_components/font-awesome/fonts/**'], {base: 'dist/assets/bower_components/'})
          .pipe(gulp.dest('dist/files/fonts'));
});

gulp.task('clean', function () {
  return gulp.src(['dist/assets/elements.html', 'dist/assets/bower_components'])
